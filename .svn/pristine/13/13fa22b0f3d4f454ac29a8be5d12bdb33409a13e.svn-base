...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["subtitle","subtotal","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
if(btn.type=="combobox"){
	tool.combobox($.extend({},btn,{plain:true}));
...
//set today onselect
var opts = $(_a4d).datebox('options');
opts.onSelect.call(_a4d, now);
