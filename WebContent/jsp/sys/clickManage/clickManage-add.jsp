...
<body>
	<div class="container">
		...
		<form class="form-horizontal" role="form" id="form" 
			action="${pageContext.request.contextPath}/clickManage/checkClick.hbc" method="post">
				...
				<div class="panel-body">
					<div class="form-group">
							...
							<div class="col-md-11 col-sm-10">
								<input type="text" class="form-control" name="keys" id="keys">
							</div>
					</div>
					<div class="form-group">
