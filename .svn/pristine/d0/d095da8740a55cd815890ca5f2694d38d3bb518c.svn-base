...
public class FormFields extends BaseEntity<FormFields> implements Serializable{
	 ...
	 */
	public void setQueryisRequired(int queryisRequired) {
	...
	public void processRow(final ResultSet rs) throws SQLException {
		...
		this.setQueryisRequired(rs.getInt("queryisRequired"));
		this.setIsRequired(rs.getInt("isRequired"));
	...
	public FormFields mapRow(final ResultSet rs, final int arg1) throws SQLException {
		...
		te.setQueryisRequired(rs.getInt("queryisRequired"));
		te.setIsRequired(rs.getInt("isRequired"));
		te.setNumber(rs.getInt("number"));
		te.setDecimalDigits(rs.getInt("decimalDigits"));
		te.setIsNull(rs.getInt("isNull"));
		te.setClickInfo(rs.getString("clickInfo"));
		te.setClickValue(rs.getString("clickValue"));
		return te;
	}
	...
	public FormFields copy()
	{
		...
		final String clickInfo = this.getClickInfo();
		final String clickValue = this.getClickValue();
		final int queryisRequired = this.getQueryisRequired();
		final int isRequired = this.getIsRequired();
		final int number = this.getNumber();
		final int decimalDigits = this.getDecimalDigits();
		final int isNull = this.getIsNull();
		te.setId(ID);
		...
		te.setClickInfo(clickInfo);
		te.setClickValue(clickValue);
		te.setQueryisRequired(queryisRequired);
		te.setIsRequired(isRequired);
		te.setNumber(number);
		te.setDecimalDigits(decimalDigits);
		te.setIsNull(isNull);
		return te;
	}
}
