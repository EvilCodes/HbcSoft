				...
				<div class="panel-body">
					...
					<div class="panel-body">
						...
						<div class="form-group">
								...
								<div class="col-md-11 col-sm-10">
									<input type="text" class="form-control" placeholder="备注" name="memo" value="${table.memo }" readonly>
								</div>
						</div>
					</div>
				</div>
							...
							<c:if test="${not empty listEntity }">
								<c:forEach items="${listEntity }" var="entity" varStatus="status">
									<tr>
										...
										<td><input type="text" class="form-control" placeholder="FIELDNAME" name="fieldName" value="${entity.fieldName }" title="${entity.fieldName}" readonly></td>
										<td><input type="text" class="form-control" placeholder="FIELDTYPE" name="fieldType" value="${entity.fieldType }" title="${entity.fieldType}" readonly></td>
										<td><input type="text" class="form-control" placeholder="FIELDVALUE" name="fieldValue" value="${entity.fieldValue }" title="${entity.fieldValue}" readonly></td>
